	...
	private void login() {
		if (controlService != null) {
			try {
				...
				if (nameText.getText().equalsIgnoreCase(controlService.getCurrentUserName(sessionID)) || nameText.getText().equalsIgnoreCase(controlService.getCurrentUser(sessionID).getMail())) {
